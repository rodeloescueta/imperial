...
import { Tv, Gamepad2, Wifi, Home } from "lucide-react"
import { DevicesReveal } from "@/components/ui/devices-reveal"

const benefits = [
  {
    icon: Tv,
    title: "No More Buffering",
    description: "Stream 4K content without interruption",
  },
  {
    icon: Gamepad2,
    title: "Low Latency Gaming",
    description: "12ms ping for competitive advantage",
  },
  {
    icon: Wifi,
  ...
  },
  {
    ...
    description: "Every device stays connected",
  },
]
...
export function InternetStruggles() {
  return (
    <section className="py-20 section-white overflow-hidden">
      <div className="container-wide">
        ...
        >
          ...
          >
            Buffering videos. Laggy games. Dropped connections.
            We&apos;ve all been there. It&apos;s time for something better.
          </motion.p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <p className="text-sm text-muted-foreground italic">
                &ldquo;Imperial is here to save the day.&rdquo;
              </p>
            </motion.div>
          </motion.div>

          {/* Right: Devices Animation */}
          <motion.div
          ...
          >
            <DevicesReveal className="mx-auto" />
          </motion.div>
        </div>
